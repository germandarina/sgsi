...
/**
 * This is the model class for table "afi_formulario".
 *
 * The followings are the available columns in table 'afi_formulario':
 * @property integer $id
...
class Formulario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('denominacion, creaUserStamp, creaTimeStamp', 'required'),
			...
			array('id, denominacion, createUserStamp, creaTimeStamp, modUserStamp, modTimeStamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'elementos' => array(self::HAS_MANY, 'ElementoFormulario', 'formularioId'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'creaUserStamp' => 'Create User Stamp',
			'creaTimeStamp' => 'Create Time Stamp',
