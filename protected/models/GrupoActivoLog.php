...
/**
 * This is the model class for table "grupo_activo_log".
 *
 * The followings are the available columns in table 'grupo_activo_log':
 * @property integer $id
 ...
 */
class GrupoActivoLog extends CustomCActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('grupo_activo_id, valor_anterior, valor_nuevo', 'numerical', 'integerOnly'=>true),
			array('creaUserStamp, modUserStamp', 'length', 'max'=>50),
			array('creaTimeStamp, modTimeStamp', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, grupo_activo_id, valor_anterior, valor_nuevo, creaUserStamp, creaTimeStamp, modUserStamp, modTimeStamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('valor_anterior',$this->valor_anterior);
	 ...
	 * @return GrupoActivoLog the static model class
	 */
