...
class Personal extends CustomCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('apellido, nombre, dni, telefono, area_id', 'required'),
			...
			array('id, apellido, nombre, dni, telefono, area_id, creaUserStamp, creaTimeStamp, modUserStamp, modTimeStamp', 'safe', 'on'=>'search'),
		);
	}
