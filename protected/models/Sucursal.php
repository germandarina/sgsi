...
/**
 * This is the model class for table "acl_sucursal".
 *
 * The followings are the available columns in table 'acl_sucursal':
 * @property integer $id
 ...
 * @property AclUser[] $aclUsers
 */
class Sucursal extends CustomCActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('nombre, creaTimeStamp, modTimeStamp', 'required'),
            array('nombre, email', 'length', 'max' => 45),
            array('direccion', 'length', 'max' => 100),
            array('creaUserStamp, modUserStamp', 'length', 'max' => 50),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nombre, direccion, email, creaUserStamp, creaTimeStamp, modUserStamp, modTimeStamp', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'users' => array(self::HAS_MANY, 'User', 'sucursalId'),
        );
    }
