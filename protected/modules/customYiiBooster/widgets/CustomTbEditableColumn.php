...
Yii::import('customYiiBooster.widgets.CustomTbEditable');
 ...
 * @package widgets
 */
class CustomTbEditableColumn extends CDataColumn
{
    /**
    ...
    */
    ...
    public function init()
    {
        ...
        CustomTbEditable::attachAjaxUpdateEvent($this->grid);
    }
    ...
    public function renderDataCellContent($row, $data)
    {
        ...
        if($isModel) {
            ...
            if(empty($this->value) && CustomTbEditable::isAutotext($this->editable, isset($this->editable['type']) ? $this->editable['type'] : '')) {
